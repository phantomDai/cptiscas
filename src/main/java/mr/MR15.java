...
//            for (int i = 0; i < 1; i++) {
                System.out.println("MR15: 开始测试" + objectName + "的" + mutantSet.getMutantID(i) + "; loop:" + loop + " numberOfThreads:" + numberOfThreads);
                ...
                //根据本蜕变关系设置取出的数据的总个数
                testProgramForSource.setDefaultNumber(DEFAULTNUMBER * 2,serviceName);
            ...
            times.clear();
            //将本次执行的结果记录到XLS文件中
            logRecorder.write(index,loop,j,numberOfThreads,objectName,"MR15",
